...
$(function captcha() {
    ...
    $("#form input").one('change keydown', function() {
        $(".start-txt").show();
    });
    ...
    $(".temp").on('click', function(e) {
        ...
        if ($auth.val() != mathenticate.solve()) {
            ...
            startRecording();
            $(".temp").removeClass();
            $("#loading").one('click', function(stopClick) {
                ...
                stopRecording();
                // 3rd click function / shows notice 
	...
	*/
    ...
    navigator.mediaDevices.getUserMedia(constraints).then(function(stream) {
        ...
        */
        ...
        $(".success-txt").hide();
        $(".notice-txt").show().html("To record, enable audio access in your browser");
...
function stopRecording() {
    ...
    $(".success-txt").show().html("Sending Submission...");
...
function createDownloadLink(blob) {
    ...
    xhr.onload = function(e) {
        if (this.readyState === 4) {
            // show success text
            $(".success-txt").show().html("Submission successful");
